...
```shell
python manage.py migrate testapp zero && rm -f testapp/migrations/0001_initial.py && python manage.py makemigrations testapp && python manage.py migrate && python manage.py insert_test_sequence_table_4_2
```
